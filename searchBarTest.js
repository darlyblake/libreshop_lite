 ...
 * Vérifie que le texte est visible sur tous les fonds
 */
...
const searchBarTests = [
  {
    ...
    foreground: COLORS.textSoft, // Utilisé dans SearchBar.tsx
    background: COLORS.card, // Fond de la barre de recherche
    expected: 4.5,
  },
  {
    name: 'ClientHomeScreen - Texte sur fond card',
    foreground: COLORS.textMuted, // Utilisé pour placeholder
