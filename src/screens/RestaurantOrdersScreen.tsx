...
const STATUS_TABS = [
  ...
  { id: 'accepted', label: 'En cuisine', emoji: '👨‍🍳', color: '#3B82F6' },
  { id: 'paid', label: 'Payées', emoji: '✅', color: '#10B981' },
...
export const RestaurantOrdersScreen: React.FC = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.background }}>
      ...
      >
        <Text style={{ color: '#fff', fontSize: 22, fontWeight: '800' }}>Commandes tables 🧾</Text>
